...
public class AgregarTicketUseCase extends UseCase<RequestCommand<AgregarTicketCommand>, ResponseEvents> {
    @Override
    public void executeUseCase(RequestCommand<AgregarTicketCommand> input) {
