...
public class CambiarPuntoDeVentaUseCase extends UseCase<RequestCommand<CambiarPuntoDeVenta>, ResponseEvents> {

    @Override
    public void executeUseCase(RequestCommand<CambiarPuntoDeVenta> input) {
