...
public class CambiarEquipoDeComputoCommand extends Command {

    protected EquipoDeComputoId equipoDeComputoId;
    protected VendedorId vendedorId;

    public CambiarEquipoDeComputoCommand(EquipoDeComputoId equipoDeComputoId, VendedorId vendedorId) {
